                ...
                <div class="post-container">                
                    ...
                    <?php
                       ...
                       if(isset($_GET['page'])){
                        ...
                        WHERE post.author = {$auth_id} /*use  WHERE this id show news according id* */
                        ...
                        {
                            $total_records = mysqli_num_rows($result1); /*total no of  record in this category show  */
                           
                           
                            $total_page = ceil($total_records / $limit);
                           echo '<ul class="pagination admin-pagination">';
                           if($page > 1){
                           echo '<li><a href="index.php?aid='. $auth_id .'&page='.($page - 1). '">Prev</a></li>'; //list create
                           }
                            ...
                            if($total_page > $page){
                              echo '<li><a href="index.php?aid='. $auth_id .'&page='.($page + 1). '">Next</a></li>';//list create
                              }
