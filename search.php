                  ...
                  <?php
                       ...
                       if(isset($_GET['page'])){
                        ...
                        if(mysqli_num_rows($result1) > 0)
                        {
                           ...
                           if($page > 1){
                           echo '<li><a href="index.php?search='.  $search_term .'&page='.($page - 1). '">Prev</a></li>'; //list create
                           }
                            ...
                            if($total_page > $page){
                              echo '<li><a href="index.php?search='.  $search_term .'&page='.($page + 1). '">Next</a></li>';//list create
                              }
